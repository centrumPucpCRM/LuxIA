...
def PreguntasFrecuentesAlumni():
    # URL de la página
    url = 'https://centrum.pucp.edu.pe/preguntas-frecuentes-alumni/'
    ...
    guardar_documento_txt("preguntas-frecuentes-alumni.txt", documento_generado)

def PreguntasFrecuentesAlumno():
    # URL de la página
    url = 'https://centrum.pucp.edu.pe/preguntas-frecuentes-alumno/'
    # Realizar solicitud HTTP
    response = requests.get(url)
    if response.status_code == 200:
        # Analizar el contenido HTML
    ...
    documento_generado=RobotEspecialistaLimpiar(resultado)
    documento_generado=reemplazar_tildes(documento_generado)
    guardar_documento_txt("preguntas-frecuentes-alumno.txt", documento_generado)